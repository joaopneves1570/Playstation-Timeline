export default function Header({anoAtivo}) {
    ...
    const selectedAno = "hover:cursor-pointer font-semibold text-md after:content-[''] after:block after:w-full after:h-0.5 after:bg-white after:mt-0.5 scale-105";
    ...
    return (
        <div className= "flex flex-row justify-center items-center gap-12 h-24 fixed top-0 left-0 w-screen bg-black backdrop-blur-md z-10">
